...
pubchem_df = pd.read_pickle("./databases/pubchemdb.tsv", encoding="utf-8", sep="\t", header=None)
chebi_df = pd.read_csv("./databases/chebidb.tsv", encoding="utf-8", sep="\t", header=None)
...
# For some reason CHEBI is already tagged
